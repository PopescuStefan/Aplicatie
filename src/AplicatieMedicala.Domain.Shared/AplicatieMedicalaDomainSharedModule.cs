...
public class AplicatieMedicalaDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AplicatieMedicalaGlobalFeatureConfigurator.Configure();
        AplicatieMedicalaModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AplicatieMedicalaDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AplicatieMedicalaResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AplicatieMedicala");

            options.DefaultResourceType = typeof(AplicatieMedicalaResource);
        ...
        {
            options.MapCodeNamespace("AplicatieMedicala", typeof(AplicatieMedicalaResource));
        });
    }
}
